        ...
        <footer>
            <div class="fixed-bottom bg-white p-4 border-top border-light border-5">
                <div style="text-align: right;">
                    <button name="page" value="edit-save" class="btn btn-white btn-sm" style="color: #FFFFFF; background-color: green;">'$lang_buttonsave'</button>&nbsp;
                    ...
                    <a href="etc/synOCR.sqlite" download="synOCR.sqlite" title="'$lang_foot_buttondownDB_tit'" class="btn btn-secondary btn-sm">'$lang_foot_buttondownDB'</a>
                </div>
            </div>
        </footer>'
fi
