...
class FindDates:
    ...
    def search_all_numeric_dates(self, act_line):
        ...
        regexlist = [
            ...
            (r"((\s)|(\())(((\d{4})(\s?)(\/)(\s?)))(0[1-9]|1[0-2])(\s?)(\/)(\s?)(0[1-9]|[12][0-9]|3[01])((\.|\,|\s|\))|\s*$)", "YMD", True),
            # D-M-Y
            (r"((\s)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(-)(\s?)(0[1-9]|[1-9]1[0-2])(\s?)(-)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", True),
            # D.M.Y
            (r"((\s)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(\.)(\s?)(0[1-9]|[1-9]|1[0-2])(\s?)(\.)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", True),
            # D/M/Y
            (r"((\s)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(\/)(\s?)(0[1-9]|[1-9]|1[0-2])(\s?)(\/)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", True),
            ...
            # D-M-Y
            (r"((\s*)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(-)(\s?)(0[1-9]|[1-9]|1[0-2])(\s?)(-)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", False),
            # D.M.Y
            (r"((\s*)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(\.)(\s?)(0[1-9]|[1-9]|1[0-2])(\s?)(\.)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", False),
            # D/M/Y
            (r"((\s*)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(\/)(\s?)(0[1-9]|1[0-2])(\s?)(\/)(\s?)(\d{2}|\d{4})((\.|\,|\s|\))|\s*$)", "DMY", False)
        ]
        # mit()
        #((\s*)|(\())(0[1-9]|[12][0-9]|3[01])(\s?)(\.)(\s?)(0[1-9]|1[0-2])(\s?)(\.)(\s?)(\d{4})((\.|\,|\s|\))|\s*$)
...
if __name__ == '__main__':
    # sys.argv=[ "test.py",
    #     '-fileWithTextFindings', 'synOCR_searchfile_IMG_0618.txt',
    #     # debug arguments
    #     '-minYear', '2000',
    #     '-maxYear', '2030',
    #     '-dbg_lvl', '1'
