...
# Create DB if necessary:
    if [ $(stat -c %s "./etc/synOCR.sqlite") -eq 0 ] || [ ! -f "./etc/synOCR.sqlite" ]; then
        ...
        sqlite3 "./etc/synOCR.sqlite" "$sqlinst"
        sleep 1
        sqlite3 "./etc/synOCR.sqlite" "INSERT INTO system ( DB_Version ) VALUES ( '4' )"
        sleep 1
